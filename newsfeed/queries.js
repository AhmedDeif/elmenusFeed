...
/*  User Story 18
    ...
    these two users.
*/
exports.createFollowUserQuery = "MATCH (d:User),(r:User) ,(s:Scores)  WHERE d.email={e1p} AND r.email = {e2p} AND d.email <> r.email   CREATE (d)-[f:FOLLOWS{ numberOfVisits :0 , totalScore :0 , score : s.followsScore}]->(r) ";
